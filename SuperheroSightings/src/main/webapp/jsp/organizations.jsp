<%-- 
    ...
    Created on : Jan 3, 2021, 9:27:19 AM
    Author     : peterriggs
--%>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link active" href="${pageContext.request.contextPath}/displayOrganizationsPage">Organizations <span class="sr-only">(current)</span></a>
            ...
            <form class="form-horizontal" 
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control" name="phone" placeholder="Phone" pattern="^\d{3}-\d{3}-\d{4}$" required/>
                        </div>
                        <div class="form-group">
            ...
            <div>
                ...
                <table id="superpowerTable" class="table table-hover table-bordered table-striped">
                    <tr>
                        ...
                        <th width="30%" class="align-middle text-center">Street</th>
                        <th width="25%" class="align-middle text-center">City</th>
                    ...
                    <c:forEach var="currentOrganization" items="${organizationList}">
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <c:out value="${currentOrganization.street}"/>
                            </td>
                            <td class="align-middle text-center">
