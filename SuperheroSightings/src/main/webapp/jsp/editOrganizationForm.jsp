<%-- 
    ...
    Created on : Jan 4, 2021, 11:21:38 PM
    Author     : peterriggs
--%>
    ...
    <body>
        <div class="container">
            <div id="editOrganization">
                <div class="text-left">
                    <h2 id="editOrganizationHeader">Edit Organization</h2>
                </div>
                <hr class="border"/>
                <div class="col text-left" id="editOrganizationFormGroup">
                    ...
                    <sf:errors path = "*" cssClass = "errorblock" element = "div" />
                        <div class="form-group row align-items-center">
                            <label for="organizationName" class="col-md-2 font-weight-bold">Organization Name:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row align-items-center">
                            <label for="organizationZip" class="col-md-2 font-weight-bold">Zip:</label>
                            <div class="col-md-6">
                        ...
                        <div class="col-md-8 text-right">
                            <a href="${pageContext.request.contextPath}/displayOrganizationsPage">
                                ...
                                <button type="submit" class="btn btn-primary shadow-sm" id="editOrganizationButton">Save Changes</button>
                        </div>
                    </sf:form>
                </div>
            </div>
